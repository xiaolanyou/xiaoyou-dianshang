            ...
            <div class="all-sort-list2"
              ...
              <div class="item"
                ...
                <h3 @mouseenter="changeIndex(index)">
                  ...
                  <!-- 会出现卡顿现象 <router-link to="/search">{{c1.categoryName}}</router-link> -->
                </h3>
                <!-- 二级、三级分类 -->
                  ...
                  <div class="subitem"
                    ...
                    <dl class="fore">
                      <dt>
                        ...
                        <!-- 会出现卡顿现象 <router-link to="/search">{{c2.categoryName}}</router-link> -->
                      </dt>
                      <dd>
                        <em v-for="(c3) in c2.categoryChild"
                          ...
                          <!-- 会出现卡顿现象 <router-link to="/search ">{{c3.categoryName}}</router-link> -->
                        </em>
                      </dd>
                    </dl>
                  </div>
...
export default {
  ...
  methods: {
    ...
    // throttle 防抖函数
    // throttle 回调函数别用箭头函数，可能出现上下文this
    ...
    goSearch(event) {
      // 最好的解决方案：编程式导航 + 事件委派
      // 利用事件委派存在一些问题：事件委派，是把全部的子节点【h3、dt、dl、em】的事件委派给父亲节点
      ...
      if (categoryname) {
        ...
        // 判断：如果路由跳转的时候，带有params参数，要一起传递过去
